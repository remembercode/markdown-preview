(function(document) {
	...
	function createGuide(show, expand, sn){
		// 生成导航栏 begin
		//是否显示导航栏
		var showNavBar = show;
		//是否展开导航栏
		var expandNavBar = expand;
		//是否显示序号
		var showSN = sn;
    ...
    function setTheme(theme) {
		...
		//var meta_width = document.createElement('meta');
		//meta_width.setAttribute('http-equiv', 'imagetoolbar');
		//meta_width.setAttribute('content', 'no');
		
		//'<meta name="viewport" content="width=device-width, initial-scale=1">'
		//document.head.appendChild(meta_width);
